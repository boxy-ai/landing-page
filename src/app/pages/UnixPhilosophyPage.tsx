      ...
      <div className="max-w-[1200px] mx-auto px-5 md:px-8">
        ...
        <div className="py-16 md:py-24 border-b border-[#222]">
          ...
          <p className="font-mono text-[15px] text-[#888] leading-[1.8] max-w-[700px]">
            The Unix philosophy has guided software design for over 50 years. We believe it's the
            right foundation for building trustworthy, secure AI agents.
          </p>
        </div>
        ...
        <div className="flex gap-12">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div id="what-is-unix" className="py-16 border-b border-[#1a1a1a]">
              ...
              <div className="max-w-[800px] mb-10">
                <p className="font-mono text-[15px] text-[#888] leading-[1.9] mb-6">
                  The Unix philosophy, originating from the design of the Unix operating system in
                  the 1970s, is built on a simple principle: write programs that do one thing and do
                  it well. Instead of building one massive, monolithic application, you build many
                  small, focused tools that can be composed together.
                </p>
                <p className="font-mono text-[15px] text-[#888] leading-[1.9]">
                  This approach has proven remarkably resilient. It's the reason the command line is
                  still powerful today, and it's the reason microservices architecture took over the
                  cloud. Small, well-defined components are easier to understand, test, secure, and
                  trust.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="border border-[#1a1a1a] p-6">
                  ...
                  <h3 className="font-mono text-[15px] text-white mb-2">Single responsibility</h3>
                  <p className="font-mono text-[13px] text-[#888] leading-[1.7]">
                    Each program does one thing. If you need new functionality, build a new program
                    rather than complicating an existing one.
                  </p>
                </div>
                <div className="border border-[#1a1a1a] p-6">
                  <Layers size={24} className="text-[#00F0FF] mb-4" />
                  <h3 className="font-mono text-[15px] text-white mb-2">Composability</h3>
                  <p className="font-mono text-[13px] text-[#888] leading-[1.7]">
                    Programs work together by passing structured data between them. The output of
                    one becomes the input of another.
                  </p>
                </div>
                <div className="border border-[#1a1a1a] p-6">
                  <ShieldCheck size={24} className="text-[#00F0FF] mb-4" />
                  <h3 className="font-mono text-[15px] text-white mb-2">Clear boundaries</h3>
                  <p className="font-mono text-[13px] text-[#888] leading-[1.7]">
                    Each program has a well-defined interface. You know exactly what goes in and
                    what comes out. No hidden side effects.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div id="unix-app-era" className="py-16 border-b border-[#1a1a1a]">
              ...
              <div className="max-w-[800px] mb-10">
                <p className="font-mono text-[15px] text-[#888] leading-[1.9] mb-6">
                  The smartphone era adopted Unix philosophy naturally. Every app on your phone is
                  designed to do one thing and do it well: your camera app takes photos, your
                  calculator calculates, your calendar manages events.
                </p>
                <p className="font-mono text-[15px] text-[#888] leading-[1.9]">
                  More importantly, each app comes with a{" "}
                  <span className="text-white">capability manifest</span> — the permissions dialog.
                  When an app asks for access to your camera, location, or contacts, you see exactly
                  what it needs. You can grant or deny each permission individually. This
                  transparency has been the backbone of user privacy on mobile platforms.
                </p>
              </div>
              ...
              <p className="font-mono text-[14px] text-[#888] leading-[1.8] max-w-[700px]">
                This model worked because each app had a narrow scope. A camera app doesn't need
                your financial data. A calculator doesn't need your contacts. The single-purpose
                design made permission management intuitive and trustworthy.
              </p>
            </div>
            ...
            <div id="unix-agentic-era" className="py-16 border-b border-[#1a1a1a]">
              ...
              <div className="max-w-[800px] mb-10">
                <p className="font-mono text-[15px] text-[#888] leading-[1.9] mb-6">
                  The AI agent landscape today has mostly abandoned this principle. The dominant
                  approach is to build one general-purpose agent that does everything — reads all
                  your data, has access to all your tools, and tries to handle any request.
                </p>
                <p className="font-mono text-[15px] text-[#888] leading-[1.9]">
                  We think this is fundamentally wrong. Most of the time, the broad data access
                  isn't actually needed, nor is access to all skills. An agent that drafts emails
                  doesn't need to read your health records. An agent that manages your calendar
                  doesn't need access to your financial data.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                <div className="border border-[#ef4444]/20 bg-[#ef4444]/5 p-6">
                  ...
                  <p className="font-mono text-[13px] text-[#888] leading-[1.7]">
                    One agent with access to everything. If it malfunctions or is compromised, all
                ...
                <div className="border border-[#10b981]/20 bg-[#10b981]/5 p-6">
                  ...
                  <p className="font-mono text-[13px] text-[#888] leading-[1.7] mt-4">
                    Each agent has minimal, declared access. If one fails, the blast radius is
                    contained.
                  </p>
                </div>
              </div>
              ...
              <div className="max-w-[800px]">
                <p className="font-mono text-[15px] text-[#888] leading-[1.9]">
                  Just like how the app permission model made mobile computing trustworthy,
                  capability manifests make AI agents trustworthy. You always know exactly what each
            ...
            <div id="agent-store" className="py-16 border-b border-[#1a1a1a]">
              ...
              <p className="font-mono text-[14px] text-[#888] leading-[1.8] mb-4 max-w-[700px]">
                The Agent Store is where you browse and select agents that fit your life. Each agent
                automates a specific aspect of your workflow, with clearly declared capabilities so
                you know exactly what you're getting.
              </p>
              <p className="font-mono text-[14px] text-[#888] leading-[1.8] mb-10 max-w-[700px]">
                The Unix philosophy makes adoption seamless: you understand what each agent does,
                what data it needs, and you can add or remove agents at any time without affecting
                others.
              </p>
                  ...
                  >
                    <div className="p-5">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="font-mono text-[14px] text-white">{agent.name}</h3>
                      </div>
